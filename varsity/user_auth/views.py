...
from user_auth.models import User, ResetPassword
from user_auth.serializers import UserSerializer, ChangePasswordSerializer, ForgotPasswordSerializer, ResetPasswordSerializer
...
class ChangePasswordAPIView(APIView):
    ...
    def put(self, request):
        ...
        #else:
            # return Response({'message': "Invalid old password"}, status=200)
...
class ForgotPasswordAPIView(APIView):
    ...
    def post(self, request):
        ...
        reset_password.save()
        email_template = template.loader.get_template('user_auth/reset-password.html')
        email_content = email_template.render({'FRONTEND_RESET_PASSWORD_URL': 'http://localhost:5500/reset-password', 'TOKEN': token})
        try:
